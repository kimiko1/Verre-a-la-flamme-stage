...
class BDD
{
    ...
    {
        if($_SERVER['REQUEST_URI'] == '/' || $_SERVER['REQUEST_URI'] == '/index.php' || $_SERVER['REQUEST_URI'] == '/connexion.php'|| $_SERVER['REQUEST_URI'] == '/inscription.php' || $_SERVER['REQUEST_URI'] == '/controle_identification.php'){
